...
import io.bootify.health_hivw.service.DataUploadRequestService;
...
public class DataUploadReqeustResource {
    ...
    private final DataUploadRequestService dataUploadReqeustService;

    public DataUploadReqeustResource(final DataUploadRequestService dataUploadReqeustService) {
